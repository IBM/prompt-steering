...
class VLLMModel(BaseModel):
    def __init__(self,
                 model_id,
                 api_config):
        super().__init__(model_id, api_config)
        self.api_base_url = api_config['base-url']
        self.api_key = api_config['api-key']

        # client params
        openai_api_key = self.api_key if self.api_key else "EMPTY"
    ...
    def _most_likely_completion(self,
        ...
        # build the set of prompts + completions
        prompts_completions = []
